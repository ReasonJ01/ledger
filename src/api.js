...
export async function apiReconciliation() {
  ...
  return {
    checks,
    notes: [
      "Per-bank coverage is not shown here. Once a bank pays interest back into the shared client-money pool, that cash is no longer attributed to a single bank in this demo, so a bank-level coverage check becomes misleading.",
    ],
    components: {
